...
def draw_orbits(space, space_objects):
    """Рисует орбиты всех тел системы.

    Для планет центром служит звезда-владелец, для спутников -- планета.
    Тела без орбитальных параметров игнорируются. Работает и для
    сгенерированной системы, и для загруженной из файла (ординаты
    достраиваются в solar_main._attach_file_orbits).
    """
